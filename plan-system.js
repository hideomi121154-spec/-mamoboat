...
(() => {
  ...
  const PLANS = Object.freeze({
    ...
    light: Object.freeze({
      id: "light", order: 1, name: "BRONZE", price: 390,
      tagline: "勝負の変化が見えてくる。",
    ...
    standard: Object.freeze({
      id: "standard", order: 2, name: "SILVER", price: 690,
      tagline: "自分でも気づかないクセまで。",
      ...
      bullets: ["BRONZEの全機能", "行動指数", "勝負トリガー分析", "個人ベースライン", "週間レポート"],
      recommended: true,
    }),
    premium: Object.freeze({
      id: "premium", order: 3, name: "GOLD", price: 1190,
      tagline: "あなた専属のMAMO BOATへ。",
      ...
      bullets: ["SILVERの全機能", "MAMO朝刊", "週間・月刊の深掘り", "理由・長期トレンド分析", "加音 守の個人記事"],
    }),
  });
  ...
  function planCard(plan) {
    ...
    return `<article class="mamo-plan-card tier-${plan.id} ${plan.recommended ? "recommended" : ""} ${active ? "active" : ""}">
