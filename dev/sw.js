...
const CACHE = "mamoboat-v514-quant-analysis-shell-step1-dev";
const SHELL = [
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    ...
    html=html.replace(/mamo-quant-analysis-shell\.js(?:\?v=[^"']+)?/g,"mamo-quant-analysis-shell.js?v=20260912-1");
    ...
    if(!html.includes("mamo-quant-analysis-shell.js")) html=html.replace("</body>",'<script src="mamo-quant-analysis-shell.js?v=20260912-1"></script></body>');
