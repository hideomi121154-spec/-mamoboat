...
const CACHE = "mamoboat-v427-race-carte-kimarite-65-dev";
const SHELL = [
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    ...
    if(!html.includes("race-carte-live-state-fix.js")){
      html=html.replace("</body>",'<script src="race-carte-live-state-fix.js?v=20260908-2"></script></body>');
    }
