...
const CACHE = "mamoboat-v420-general-grade-blue-58-dev";
const SHELL = [
  ...
  "./decision-transition-model.js","./growth-entry.js?v=20260830-1","./venue-live-priority.js?v=20260907-2","./general-grade-theme.js?v=20260908-1","./manifest.webmanifest","./icon.svg","./mamoru-hero.webp",
