...
const CACHE = "mamoboat-v504-odds-bet-mobile-selector-dev";
const SHELL = [
  "./","./index.html","./air-bet-selection-fixed.css?v=20260911-8","./odds-bet-mode.css?v=20260911-1","./styles.css?v=20260910-3","./air-bet-review-compact.css?v=20260911-13","./brand-theme.css?v=20260827-2","./core.js?v=20260908-1","./air-bet-draft-core.js?v=20260909-2","./pilot-config.js?v=20260910-6","./app.js?v=20260910-4",
  "./decision-event-schema.js","./decision-conflict-core.js","./decision-conflict-guard.js?v=20260906-2","./decision-event-collector.js?v=20260910-2","./decision-event-api-compat.js?v=20260911-1","./bet-review-flow.js?v=20260911-4","./air-bet-review-delete-controls.js?v=20260911-3","./odds-bet-mode-v1.js?v=20260911-2",
  "./decision-transition-model.js","./growth-entry.js?v=20260908-2","./venue-live-priority.js?v=20260909-1","./air-bet-mode-stability.js?v=20260911-12","./race-layout-refresh.js?v=20260911-7","./race-airbet-compact.js?v=20260910-6","./race-airbet-first.js?v=20260910-8","./race-carte-official-payouts.js?v=20260911-1","./ai-safe.js?v=20260910-5","./general-grade-theme.js?v=20260908-1","./air-outcome-experience.js?v=20260909-5","./record-unified-layout-v2.js?v=20260909-5","./record-mobile-layout-fix.js?v=20260908-2","./race-carte-live-state-fix.js?v=20260908-3","./race-carte-manual-refresh.js?v=20260909-3","./manifest.webmanifest","./icon.svg","./mamoru-hero.webp",
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    ...
    html=html.replace(/air-bet-mode-stability\.js\?v=[^"']+/g,"air-bet-mode-stability.js?v=20260911-12");
    ...
    html=html.replace(/odds-bet-mode-v1\.js(?:\?v=[^"']+)?/g,"odds-bet-mode-v1.js?v=20260911-2");
    if(html.includes("air-bet-selection-fixed.css")) {
      html=html.replace(/air-bet-selection-fixed\.css\?v=[^"']+/g,"air-bet-selection-fixed.css?v=20260911-8");
    } else {
      html=html.replace("</head>",'<link rel="stylesheet" href="air-bet-selection-fixed.css?v=20260911-8"></head>');
    }
    if(html.includes("odds-bet-mode.css")) {
      html=html.replace(/odds-bet-mode\.css\?v=[^"']+/g,"odds-bet-mode.css?v=20260911-1");
    } else {
      html=html.replace("</head>",'<link rel="stylesheet" href="odds-bet-mode.css?v=20260911-1"></head>');
    }
    ...
    if(!html.includes("air-bet-mode-stability.js")) html=html.replace("</body>",'<script src="air-bet-mode-stability.js?v=20260911-12"></script></body>');
    ...
    if(!html.includes("odds-bet-mode-v1.js")) html=html.replace("</body>",'<script src="odds-bet-mode-v1.js?v=20260911-2"></script></body>');
