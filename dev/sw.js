...
const CACHE = "mamoboat-v465-airbet-selector-visible-dev";
const SHELL = [
  ...
  "./decision-transition-model.js","./growth-entry.js?v=20260908-2","./venue-live-priority.js?v=20260909-1","./air-bet-mode-stability.js?v=20260910-6","./race-layout-refresh.js?v=20260908-2","./race-airbet-first.js?v=20260909-5","./general-grade-theme.js?v=20260908-1","./air-outcome-experience.js?v=20260909-5","./record-unified-layout-v2.js?v=20260909-5","./record-mobile-layout-fix.js?v=20260908-2","./race-carte-live-state-fix.js?v=20260908-3","./race-carte-manual-refresh.js?v=20260909-3","./manifest.webmanifest","./icon.svg","./mamoru-hero.webp",
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    ...
    if(!html.includes("air-bet-mode-stability.js")) html=html.replace("</body>",'<script src="air-bet-mode-stability.js?v=20260910-6"></script></body>');
