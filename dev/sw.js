...
const CACHE = "mamoboat-v455-air-bet-picker-stability-92-dev";
const SHELL = [
  ...
  "./decision-transition-model.js","./growth-entry.js?v=20260908-2","./venue-live-priority.js?v=20260909-1","./air-bet-multi-add.js?v=20260909-7","./air-bet-selection-reset.js?v=20260909-1","./air-bet-mode-stability.js?v=20260909-4","./race-layout-refresh.js?v=20260908-2","./race-airbet-first.js?v=20260909-5","./general-grade-theme.js?v=20260908-1","./air-outcome-experience.js?v=20260909-5","./record-unified-layout-v2.js?v=20260909-4","./record-mobile-layout-fix.js?v=20260908-2","./race-carte-live-state-fix.js?v=20260908-3","./race-carte-manual-refresh.js?v=20260909-3","./manifest.webmanifest","./icon.svg","./mamoru-hero.webp",
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    ...
    if(!html.includes("record-unified-layout-v2.js")) html=html.replace("</body>",'<script src="record-unified-layout-v2.js?v=20260909-4"></script></body>');
    ...
    if(!html.includes("air-bet-selection-reset.js")) html=html.replace("</body>",'<script src="air-bet-selection-reset.js?v=20260909-1"></script></body>');
    ...
    if(!html.includes("mamo-air-bet-review-cleanup")) html=html.replace("</head>",'<style id="mamo-air-bet-review-cleanup">[data-air-bet-review]~#reviewBetSummary,.review-stake-prompt,.editorial-safety{display:none!important}</style></head>');
