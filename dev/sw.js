...
const CACHE = "mamoboat-v468-race-airbet-header-compact-dev";
const SHELL = [
  ...
  "./decision-transition-model.js","./growth-entry.js?v=20260908-2","./venue-live-priority.js?v=20260909-1","./air-bet-mode-stability.js?v=20260910-7","./race-layout-refresh.js?v=20260910-1","./race-airbet-compact.js?v=20260910-1","./race-airbet-first.js?v=20260910-1","./general-grade-theme.js?v=20260908-1","./air-outcome-experience.js?v=20260909-5","./record-unified-layout-v2.js?v=20260909-5","./record-mobile-layout-fix.js?v=20260908-2","./race-carte-live-state-fix.js?v=20260908-3","./race-carte-manual-refresh.js?v=20260909-3","./manifest.webmanifest","./icon.svg","./mamoru-hero.webp",
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    ...
    if(!html.includes("race-airbet-compact.js")) html=html.replace("</body>",'<script src="race-airbet-compact.js?v=20260910-1"></script></body>');
