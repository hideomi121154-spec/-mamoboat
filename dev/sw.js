...
const CACHE = "mamoboat-v426-record-payout-details-64-dev";
const SHELL = [
  "./","./index.html","./styles.css?v=20260906-3","./brand-theme.css?v=20260827-2","./core.js?v=20260908-1","./pilot-config.js?v=20260908-1","./app.js?v=20260908-1",
  ...
  "./decision-transition-model.js","./growth-entry.js?v=20260830-1","./venue-live-priority.js?v=20260907-2","./general-grade-theme.js?v=20260908-1","./air-outcome-experience.js?v=20260908-3","./record-unified-layout-v2.js?v=20260908-3","./record-mobile-layout-fix.js?v=20260908-2","./race-carte-live-state-fix.js?v=20260908-1","./manifest.webmanifest","./icon.svg","./mamoru-hero.webp",
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    ...
    if(!html.includes("race-carte-live-state-fix.js")){
      html=html.replace("</body>",'<script src="race-carte-live-state-fix.js?v=20260908-1"></script></body>');
    }
