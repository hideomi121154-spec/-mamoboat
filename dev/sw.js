...
const CACHE = "mamoboat-v465-air-bet-more-ticket-room-102-dev";
const SHELL = [
  "./","./index.html","./styles.css?v=20260910-2","./air-bet-review-compact.css?v=20260910-5","./brand-theme.css?v=20260827-2","./core.js?v=20260908-1","./air-bet-draft-core.js?v=20260909-2","./pilot-config.js?v=20260909-4","./app.js?v=20260910-2",
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    if(html.includes("air-bet-review-compact.css")) {
      html=html.replace(/air-bet-review-compact\.css\?v=[^\"']+/g,"air-bet-review-compact.css?v=20260910-5");
    } else {
      html=html.replace("</head>",'<link rel="stylesheet" href="air-bet-review-compact.css?v=20260910-5"></head>');
    }
