...
const SHELL = [
  "./","./index.html","./air-bet-selection-fixed.css?v=20260910-4","./styles.css?v=20260910-3","./air-bet-review-compact.css?v=20260911-12","./brand-theme.css?v=20260827-2","./core.js?v=20260908-1","./air-bet-draft-core.js?v=20260909-2","./pilot-config.js?v=20260910-6","./app.js?v=20260910-4",
  "./decision-event-schema.js","./decision-conflict-core.js","./decision-conflict-guard.js?v=20260906-2","./decision-event-collector.js?v=20260910-2","./decision-event-api-compat.js?v=20260908-2","./bet-review-flow.js?v=20260911-2",
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    ...
    html=html.replace(/bet-review-flow\.js(?:\?v=[^"']+)?/g,"bet-review-flow.js?v=20260911-2");
    if(html.includes("air-bet-selection-fixed.css")) {
      ...
      html=html.replace("</head>",'<link rel="stylesheet" href="air-bet-selection-fixed.css?v=20260910-4"></head>');
    }
    if(html.includes("air-bet-review-compact.css")) {
      html=html.replace(/air-bet-review-compact\.css\?v=[^"']+/g,"air-bet-review-compact.css?v=20260911-12");
    } else {
      html=html.replace("</head>",'<link rel="stylesheet" href="air-bet-review-compact.css?v=20260911-12"></head>');
    }
