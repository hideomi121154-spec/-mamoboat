...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    ...
    if(html.includes("air-bet-review-compact.css")) {
      html=html.replace(/air-bet-review-compact\.css\?v=[^"']+/g,"air-bet-review-compact.css?v=20260911-11");
    } else {
      html=html.replace("</head>",'<link rel="stylesheet" href="air-bet-review-compact.css?v=20260911-11"></head>');
    }
