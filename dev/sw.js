...
const CACHE = "mamoboat-v423-readable-record-layout-61-dev";
const SHELL = [
  ...
  "./decision-transition-model.js","./growth-entry.js?v=20260830-1","./venue-live-priority.js?v=20260907-2","./general-grade-theme.js?v=20260908-1","./record-financial-detail-fix.js?v=20260908-1","./record-unified-layout-v2.js?v=20260908-2","./manifest.webmanifest","./icon.svg","./mamoru-hero.webp",
