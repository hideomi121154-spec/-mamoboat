...
const CACHE = "mamoboat-v429-air-bet-draft-tray-67-dev";
const SHELL = [
  ...
  "./decision-transition-model.js","./growth-entry.js?v=20260908-2","./venue-live-priority.js?v=20260908-2","./air-bet-multi-add.js?v=20260908-2","./race-layout-refresh.js?v=20260908-2","./general-grade-theme.js?v=20260908-1","./air-outcome-experience.js?v=20260908-3","./record-unified-layout-v2.js?v=20260908-3","./record-mobile-layout-fix.js?v=20260908-2","./race-carte-live-state-fix.js?v=20260908-3","./manifest.webmanifest","./icon.svg","./mamoru-hero.webp",
...
function withLiveVenueLoader(response){
  ...
  return response.text().then(html=>{
    if(!html.includes("venue-live-priority.js")){
      html=html.replace("</body>",'<script src="venue-live-priority.js?v=20260908-2"></script></body>');
    }
