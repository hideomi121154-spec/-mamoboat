...
(() => {
  ...
  function unifiedCard(r,index){
    ...
    return `<article class="rx-card rx-unified ${x.tone}">
      ...
      <details class="rx-bets"><summary>購入した買い目 <b>${Array.isArray(r.lines)?r.lines.length:0}点</b></summary><div>${linesHtml(r)}</div></details>
  ...
  function style(){
    ...
    s.textContent=`
      ...
      .rx-bets>summary{display:flex;align-items:center;gap:9px;min-height:48px;padding:10px 11px;list-style:none;color:#082b4a;font-size:12px;font-weight:1000;-webkit-tap-highlight-color:transparent}
      .rx-bets>summary::-webkit-details-marker{display:none}
      .rx-bets>summary::before{content:"▶";display:grid;place-items:center;width:26px;height:26px;flex:0 0 26px;border-radius:7px;background:#082b4a;color:#fff;font-size:11px;line-height:1;box-shadow:0 2px 5px rgba(8,43,74,.18)}
      .rx-bets[open]>summary::before{content:"▼"}
      .rx-bets>summary::after{content:"開く";margin-left:auto;color:#607582;font-size:9px;font-weight:1000;letter-spacing:.03em}
      .rx-bets[open]>summary::after{content:"閉じる"}
      ...
      @media(max-width:520px){.rx-summary-grid{grid-template-columns:1fr 1fr}.rx-record-hero h2{font-size:22px}.rx-actions{grid-template-columns:1fr 1fr}.rx-bets>summary{min-height:54px;font-size:14px}.rx-bets>summary::before{width:28px;height:28px;flex-basis:28px;font-size:12px}.rx-bets>summary::after{font-size:10px}}
