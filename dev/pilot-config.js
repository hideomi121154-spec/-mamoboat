...
if (raceLayoutRefresh) raceLayoutRefresh[0] = "race-layout-refresh.js?v=20260908-2";
{
  ...
  MAMO_SCRIPTS.splice(airIndex + 1, 0,
    ...
    ["record-mobile-layout-fix.js?v=20260908-2", "record-mobile-layout"]
  );
}
