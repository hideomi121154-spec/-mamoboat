...
assert.match(indexSource, /app\.js\?v=20260823-1/);
...
assert.match(serviceWorkerSource, /mamoboat-v401-growth-entry-26/);
...
assert.match(swRefreshSource, /Service Worker refresh v26/);
