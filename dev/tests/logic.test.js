...
assert.match(indexSource, /styles\.css\?v=20260910-2/);
...
assert.match(indexSource, /app\.js\?v=20260910-2/);
...
assert.match(serviceWorkerSource, /mamoboat-v460-air-bet-ticket-scroll-97-dev/);
