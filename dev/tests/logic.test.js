...
assert.match(indexSource, /styles\.css\?v=20260910-1/);
...
assert.match(indexSource, /app\.js\?v=20260910-1/);
...
assert.match(serviceWorkerSource, /mamoboat-v459-air-bet-fixed-review-96-dev/);
