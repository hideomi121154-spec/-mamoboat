...
assert.match(indexSource, /styles\.css\?v=20260908-2/);
...
assert.match(indexSource, /pilot-config\.js\?v=20260909-4/);
assert.match(indexSource, /app\.js\?v=20260908-2/);
...
assert.match(serviceWorkerSource, /mamoboat-v456-air-bet-canonical-flow-93-dev/);
...
assert.match(pilotConfigSource, /decisionEventCompat\[0\] = "decision-event-api-compat\.js\?v=20260908-2"/);
