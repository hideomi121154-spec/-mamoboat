...
assert.match(indexSource, /styles\.css\?v=20260910-3/);
...
assert.match(indexSource, /app\.js\?v=20260910-4/);
...
assert.match(serviceWorkerSource, /mamoboat-v491-review-nav-layout-dev/);
