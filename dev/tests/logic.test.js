...
assert.match(indexSource, /pilot-config\.js\?v=20260906-1/);
assert.match(indexSource, /app\.js\?v=20260906-1/);
...
assert.match(serviceWorkerSource, /mamoboat-v414-ios-event-unlock-52-dev/);
...
assert.match(pilotConfigSource, /decision-event-api-compat\.js\?v=20260906-1/);
