...
assert.match(indexSource, /pilot-config\.js\?v=20260831-2/);
assert.match(indexSource, /app\.js\?v=20260831-2/);
...
assert.match(serviceWorkerSource, /mamoboat-v412-decision-conflict-50-dev/);
...
assert.match(pilotConfigSource, /decision-event-api-compat\.js\?v=20260831-1/);
