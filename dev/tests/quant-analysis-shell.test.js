...
assert.match(helper, /__MAMO_QUANT_ANALYSIS_SHELL_V9__/);
...
assert.match(helper, /実績リスク分析を読み込めませんでした/);
...
console.log("quant analysis shell STEP 8 delivery checks passed");
