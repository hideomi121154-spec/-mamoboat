...
assert.match(helper, /__MAMO_QUANT_ANALYSIS_SHELL_V4__/);
...
assert.match(helper, /showPerformanceLoadFailure/);
assert.match(helper, /オッズ帯別成績を読み込めませんでした/);
...
console.log("quant analysis shell STEP 5.2 delivery checks passed");
