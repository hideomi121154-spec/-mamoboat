...
test("MAMO STORY uses 16 same-origin panel images", () => {
  ...
  assert.match(pilotSource, /sw-refresh\.js\?v=20260831-35/);
  assert.match(refreshSource, /mamo-story\.js\?v=20260830-4/);
...
test("all 16 MAMO STORY PNG panels are valid and readable", () => {
  ...
  for (const panel of panels) {
    ...
    if (["mamo-story-04.png", "mamo-story-06.png", "mamo-story-07.png", "mamo-story-08.png", "mamo-story-09.png", "mamo-story-11.png", "mamo-story-14.png", "mamo-story-15.png"].includes(panel)) {
