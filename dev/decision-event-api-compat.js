...
(() => {"use strict";if(document.querySelector('script[data-mamo-bet-review-flow]'))return;const script=document.createElement("script");script.src="bet-review-flow.js?v=20260831-1";script.async=true;script.dataset.mamoBetReviewFlow="1";document.head.appendChild(script);})();
