...
(() => {"use strict";if(document.querySelector('script[data-mamo-record="phase1"]'))return;const script=document.createElement("script");script.src="mamo-record.js?v=20260821-3";script.async=true;script.dataset.mamoRecord="phase1";document.head.appendChild(script);})();
...
(() => {
  ...
  const marketplace = () => {
    ...
    script.src = "mamo-shop-marketplace.js?v=20260828-2";
    script.async = true;
