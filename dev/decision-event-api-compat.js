...
(() => {"use strict";if(document.querySelector('script[data-mamo-home-deadline-touch-fix]'))return;const script=document.createElement("script");script.src="home-deadline-touch-fix.js?v=20260830-2";script.async=true;script.dataset.mamoHomeDeadlineTouchFix="1";document.head.appendChild(script);})();
